<?php
	...
	class SRStockDetails implements InputFilterAwareInterface {
		public $SR_STOCK_DIST_DETAILS_ID;
		...
		public function exchangeArray($data) {
			$this->SR_STOCK_DIST_DETAILS_ID 	= (!empty($data['SR_STOCK_DIST_DETAILS_ID'])) ? $data['SR_STOCK_DIST_DETAILS_ID'] : null;
